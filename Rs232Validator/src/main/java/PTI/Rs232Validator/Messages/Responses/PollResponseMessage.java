...
public class PollResponseMessage extends Rs232ResponseMessage{
    ...
    /**
     * The expected size of {@link #Status}
     */
    protected static final byte StatusByteSize = 6;

    /**
     * A map of (byteIndex, bitIndex) pairs in {@link #Status} to {@link Rs232State}.
     */
    ...
    /**
     * A map of (byteIndex, bitIndex) pairs in {@link #Status} to {@link Rs232Event}.
     */
    private static final Map<Tuple<Byte, Byte>, Byte> EventMap = Map.of(
            new Tuple<>((byte) 0, (byte) 4), Rs232Event.Stacked,
            new Tuple<>((byte) 0, (byte) 6), Rs232Event.Returned,
            new Tuple<>((byte) 1, (byte) 0), Rs232Event.Cheated,
            new Tuple<>((byte) 1, (byte) 1), Rs232Event.BillRejected,
            new Tuple<>((byte) 2, (byte) 0), Rs232Event.PowerUp,
            new Tuple<>((byte) 2, (byte) 1), Rs232Event.InvalidCommand);

    /**
     * A map of byte indices in {@link #Status} to reserved bit indices
     */
    ...
    /**
     * Initializes a new instance of {@link PollResponseMessage}
     */
    ...
    /**
     * Initializes a new instance of {@link PollResponseMessage}
     * @param payload {@link PTI.Rs232Validator.Messages.Rs232Message#Payload Payload}
    ...
    /**
     * An enumerator of {@link Rs232State}
     */
    ...
    /**
     * An enumerator of {@link Rs232Event}
     */
    private Rs232Event Event = new Rs232Event((byte)0);

    /**
     * Returns {@link #Event}
     * @return {@link #Event}
     */
    public Rs232Event getEvent(){
        return Event;
    }

    /**
     * Is the cashbox present?
     * @implNote For stackerless models, this will always be true
     */
    private boolean IsCashboxPresent;

    /**
     * Returns {@link #IsCashboxPresent}
     * @return {@link #IsCashboxPresent}
     */
    ...
    /**
     * Returns the bill type in escrow
     * @return {@link #BillType}
     */
    ...
    /**
     * Returns {@link #ModelNumber}
     * @return {@link #ModelNumber}
     */
    ...
    /**
     * Firmware revision
     * @implNote 1.17 returns 17
     */
    private byte FirmwareRevision;

    /**
     * Returns {@link #FirmwareRevision}
     * @return {@link #FirmwareRevision}
     */
    ...
    public String toString(){
        return IsValid.get()
                ...
                "Model Number: %d | " +
                "Firmware Revision: %d | " +
                "Is Cashbox Present: %b", State.name(), Event.Flags(), BillType, ModelNumber, FirmwareRevision, IsCashboxPresent)
                : super.toString();
    }
    ...
    private void DeserializeStatus(){
        ...
        for(Map.Entry<Tuple<Byte, Byte>, Byte> pair : EventMap.entrySet()){
            ...
            Byte bitIndex = pair.getKey().y;
            if(IsBitSet(Status.get(byteIndex.intValue()), bitIndex)){
                Event.setFlag(pair.getValue());
            }
        }

        IsCashboxPresent = IsBitSet(Status.get(1), (byte)4);
    ...
    /**
     * Returns {@link #PayloadIssues}
     * @return {@link #PayloadIssues}
     */
